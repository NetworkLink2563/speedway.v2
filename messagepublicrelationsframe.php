           ...
           <div class="" style="display: flex; flex-direction: column; justify-content: center; align-items: center ; background-color: white;">
                   ...
                   <div class="col-12 row" style="padding: 0; flex-wrap: nowrap;">
                    ...
                    <div class="col-8 text-center" style="margin: 1rem;">
                      <button type="button"  id="btn_saveframe3" class="btn" style="background-color:#009933;color:white" >บันทึก<i style="margin-left: 5px;color:white;font-size: 16px;" class="fa fa-save"></i></button>
