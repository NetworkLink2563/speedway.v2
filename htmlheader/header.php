        ...
        <ul class="navbar-nav mr-auto f10pt">
            <li class="nav-item dropdown ">
                ...
                <div class="dropdown-menu"  style="background: #FFFFFF"aria-labelledby="dropdown01">
                    ...
                    <a class="dropdown-item f10pt"  href="index.php">ออกจาโปรแกรม</a>
                </div>
            </li>
            <li class="nav-item dropdown ">
                <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">การควบคุถม</a>
                <div class="dropdown-menu"  style="background: #FFFFFF"aria-labelledby="dropdown01">
                    <a class="dropdown-item f10pt"  href="consolbanner.php">การควบคุมป้าย</a>
                    <a class="dropdown-item f10pt"  href="LabelWorkSchedule.php">ตรางการทำงานของป้าย</a>
                </div>
            </li>
            <li class="nav-item dropdown ">
                <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">การแสดงความข้อความ</a>
                <div class="dropdown-menu"  style="background: #FFFFFF"aria-labelledby="dropdown01">
            ...
            <li class="nav-item dropdown ">
                <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">รายงาน</a>
                <div class="dropdown-menu"  style="background: #FFFFFF"aria-labelledby="dropdown01">
                    <a class="dropdown-item f10pt"  href="#">รายงานการปฏิบัติงาน</a>
                    <a class="dropdown-item f10pt"  href="#">รายงานข้อความป้าย</a>
                    <a class="dropdown-item f10pt"  href="#">รายงานสถานะป้าย</a>
                    <a class="dropdown-item f10pt"  href="#">รายงานระดับความสว่าง</a>
                </div>
            </li>
        </ul>
