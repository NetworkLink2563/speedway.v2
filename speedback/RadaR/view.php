                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="col-md-6 text-end row">
                                        ...
                                        <div class="col-6 text-left">
                                            <span class="text-gray-400 mt-1 fw-semibold fs-6">อุปกรณ์เรด้านับรถ</span>
                                    ...
                                    <div class="col-md-6 text-end row">
                                        ...
                                        <div class="col-3 text-left">
                                            ...
                                            <select id="SelType" class="form-control">
                                                <option value="1">กราฟแสดงปริมาณรถ</option>
                                                <option value="2">กราฟแสดงความเร็วเฉลี่ย</option>
                                                <option value="3">ตารางข้อมูลปริมาณรถ</option>
