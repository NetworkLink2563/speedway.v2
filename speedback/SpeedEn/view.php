                    ...
                    <div class="card pt-3">
                        ...
                        ?>
                             <button style="position: absolute; top: 5%; z-index: 10;" type="button" id="BtnAdd" class="btn btn-dark ms-4 py-1 fs-8">
                                ...
                                เพิ่มกล้องตรวจจับความเร็ว</button>
                        <?php
                            }
                        ?>
                        </div>
    ...
    <div class="modal-dialog  modal-lg card shadow">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="HeaderTitle" class="modal-title"></h5>
                <!--
...
-->
            ...
            <div class="modal-body card shadow">
                <form id="FormSpeedEnforce" class="user" method="POST" action="Controller.php">
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 ">
                            <label class="m-0">รหัสเครื่อง:</label>
                            <input type="text" class="<?php echo $Permis[1];?> form-control w-25" value="SPEYY-XXXXX"
                                placeholder="" id="TxtSpeCode" autocomplete="off" disabled>
                        </div>
                    </div>
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 m-0">
                    ...
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 ">
                            ...
                            <input type="text" class="<?php echo $Permis[1];?> form-control w-75" placeholder=""
                                id="TxtSpeName" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 m-0">
                            ...
                            <input type="text" class="<?php echo $Permis[1];?> form-control w-25" placeholder=""
                                id="TxtSpeSN" autocomplete="off" required>
                        </div>
                    </div>
