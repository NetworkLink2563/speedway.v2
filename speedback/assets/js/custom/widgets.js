...
var KTWidgets = function () {
    ...
    // Charts widgets
    var initChartsWidgetDashboard2 = function() {
        var el = document.getElementById('kt_charts_widget_dashboard_chart_2'); 
        ...
        // Init 
        drawCircle('#3699FF', options.lineWidth, 100 / 100);  
        drawCircle('#F64E60', options.lineWidth, 85 / 100);
        drawCircle('#FFA800', options.lineWidth, 60 / 100); 
        drawCircle('#F66B0E', options.lineWidth, 45 / 100); 
        drawCircle('#8950FC', options.lineWidth, 30 / 100); 
        drawCircle('#0BAAB5', options.lineWidth, 15 / 100); 
    }

    // Charts widgets
    var initChartsWidgetDashboard1 = function() {
        var element = document.getElementById("kt_charts_widget_dashboard_chart");
        ...
        var initChart = function() {
            ...
            var baseColor = "#F66B0E"
            var secondaryColor = "#FFA800";  
            var thirdColor = "#FFE1B2"      
            ...
            var options = {
                ...
                xaxis: {
                    categories: ['1Aug', '8Aug', '15Aug', '22Aug', '29Aug', '5Sep'],
                    axisBorder: {
                        show: false,
                    },
                    axisTicks: {
