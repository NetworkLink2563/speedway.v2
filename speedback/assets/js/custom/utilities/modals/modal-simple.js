...
var ModalSimple = function () {
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_edit');
			...
			form = document.querySelector('#kt_modal_edit_form');
			submitButton = document.getElementById('kt_modal_edit_submit');
			cancelButton = document.getElementById('kt_modal_edit_cancel');
