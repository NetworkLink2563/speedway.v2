...
var KTChartsWidget5 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['กล้องวงจรปิด', 'วันสภาพอากาศ', 'เครื่องวัดความชื้น', 'เครื่องตรวจจับความร้อน', 'เครื่องตรวจจับรังสี', 'เครื่องวัดค่าเสียง', 'อื่น ๆ'],
                labels: {
                    formatter: function (val) {
                      return val + "K"
                    },
...
const datatable = $('.datatable').DataTable({
	"fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
		return `แสดง ${iStart} - ${iEnd} | ทั้งหมด ${iTotal} รายการ`;
	}
});
