        ...
        <div class="modal-content">
            ...
            <form id="kt_modal_edit_form" class="form" action="#">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <!--begin::Scroll-->
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_scroll" data-kt-scroll="true"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">ตัวอย่าง การแสดงผล</h4>
                                    <div class="fs-6 text-gray-700">ข้อความตัวอย่าง การแสดงผล
                                        <a href="#">Hell World Income</a>
                                    </div>
                                </div>
                                <!--end::Content-->
                            </div>
                        ...
                        <div class="mb-5 fv-row">
                            <!--begin::Label-->
                            <label class="required fs-5 fw-semibold mb-2">Field Name</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="d-flex flex-column mb-10 fv-row">
                            ...
                            <select name="category" data-control="select2" data-hide-search="true"
                                ...
                                <option value="3">Monobread</option>
                            ...
                            <div class="mb-3">
                                ...
                                <label class="d-flex align-items-center fs-5 fw-semibold">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                        title="Your billing numbers will be calculated based on your API method"></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Description-->
                ...
                <div class="modal-footer flex-center">
                    <!--begin::Button-->
                    <button type="reset" id="kt_modal_edit_cancel" class="btn btn-light me-3">Discard</button>
                    <!--end::Button-->
                    <!--begin::Button-->
...
<div class="modal fade" id="kt_modal_delete" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_delete_header">
                <!--begin::Modal title-->
                <h2>Delete</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <!--end::Modal header-->
            <!--begin::Form Delete-->
            <form id="kt_modal_delete_form" class="form" action="#">
                <!--begin::Modal body-->
                <div class="modal-body py-10 px-lg-17">
                    <!--begin::Scroll-->
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_delete_scroll" data-kt-scroll="true"
                        data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                        data-kt-scroll-dependencies="#kt_modal_delete_header"
                        data-kt-scroll-wrappers="#kt_modal_delete_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Notice-->
                        <div
                            class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-10 p-6">
                            <!--begin::Icon-->
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                <!--begin::Content-->
                                <div class="fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">ตัวอย่าง การลบข้อมูล</h4>
                                    <div class="fs-6 text-gray-700">ข้อความตัวอย่าง การลบข้อมูล
                                        <a href="#">ตรวจสอบอย่างละเอียด</a>
                                    </div>
                                </div>
                                <!--end::Content-->
                            </div>
                ...
                <div class="modal-footer flex-center">
                    <!--begin::Button-->
                    <button type="reset" id="kt_modal_delete_cancel" class="btn btn-light me-3">Discard</button>
                    <!--end::Button-->
                    <!--begin::Button-->
    ...
    <div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
        ...
        <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
            ...
            <div class="card-title">
                ...
                <div class="d-flex justify-content-center flex-column me-3">
                    <a href="#" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">สมหมาย</a>
                    <!--begin::Info-->
                    <div class="mb-0 lh-1">
                ...
                <div class="me-2">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">รายชื่อ</div>
                        </div>
                        <!--end::Heading-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_users_search">เพิ่มรายชื่อใหม่</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link flex-stack px-3" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_invite_friends">เชิญบุคคลอื่น
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-bs-toggle="tooltip"
                                        title="Coming soon">สร้างกลุ่มใหม่</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-bs-toggle="tooltip"
                                        title="Coming soon">เชิญบุคคลอื่น</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-bs-toggle="tooltip"
                                        title="Coming soon">ตั้งค่า</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu sub-->
                        ...
                        <div class="menu-item px-3 my-1">
                            <a href="#" class="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">ตั้งค่า</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    <!--end::Menu 3-->
                ...
                <div class="d-flex justify-content-start mb-10">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <!--begin::Details-->
                            <div class="ms-3">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">สมหมาย</a>
                                <span class="text-muted fs-7 mb-1">2 นาทีที่แล้ว</span>
                            </div>
                            <!--end::Details-->
                        </div>
                        <!--end::User-->
                ...
                <div class="d-flex justify-content-end mb-10">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Details-->
                            <div class="me-3">
                                <span class="text-muted fs-7 mb-1">5 นาทีที่แล้ว</span>
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1">คุณ</a>
                            </div>
                            <!--end::Details-->
                            <!--begin::Avatar-->
                            <div class="symbol symbol-35px symbol-circle">
                ...
                <div class="d-flex justify-content-end mb-10">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Details-->
                            <div class="me-3">
                                <span class="text-muted fs-7 mb-1">2 ชั่วโมงที่แล้ว</span>
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1">คุณ</a>
                            </div>
                            <!--end::Details-->
                            <!--begin::Avatar-->
                ...
                <div class="d-flex justify-content-start mb-10">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="ms-3">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">สมหมาย</a>
                                <span class="text-muted fs-7 mb-1">3 ชั่วโมงที่แล้ว</span>
                            </div>
                            <!--end::Details-->
                        </div>
                        <!--end::User-->
                        ...
                        <div class="p-5 rounded bg-light-info text-dark fw-semibold mw-lg-400px text-start"
                            ...
                            here:
                            <a href="https://monobread.com">monobread.com</a>
                        </div>
                        <!--end::Text-->
                    </div>
                    <!--end::Wrapper-->
                ...
                <div class="d-flex justify-content-end mb-10">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Details-->
                            <div class="me-3">
                                <span class="text-muted fs-7 mb-1">4 ชั่วโมงที่แล้ว</span>
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1">คุณ</a>
                            </div>
                            <!--end::Details-->
                            <!--begin::Avatar-->
                ...
                <div class="d-flex justify-content-start mb-10">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="ms-3">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">สมหมาย</a>
                                <span class="text-muted fs-7 mb-1">5 ชั่วโมงที่แล้ว</span>
                            </div>
                            <!--end::Details-->
                        </div>
                        <!--end::User-->
        ...
        <div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
            ...
            <div class="d-flex flex-stack">
                ...
                <!--end::Actions-->
                <!--begin::Send-->
                <button class="btn btn-primary" type="button" data-kt-element="send">ส่งข้อความ</button>
                <!--end::Send-->
            </div>
            <!--end::Toolbar-->
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    <!--begin::Title-->
                    <h1 class="mb-3">การเข้าใช้ระบบล่าสุด</h1>
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="text-muted fw-semibold fs-5">ผู้ใช้งานล่าสุดที่เข้าใช้งานระบบ หรือ ค้นหา
                        <a href="#" class="link-primary fw-bold">รายชื่อผู้ใช้งาน</a>.
                    </div>
                    <!--end::Description-->
                </div>
                <!--end::Heading-->
                        ...
                        <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="text-end">
                                    ...
                                    <div class="fs-7 text-muted">จำนวนเข้าใช้งานประจำเดือน</div>
                                </div>
                                <!--end::Sales-->
                            </div>
                            <!--end::Stats-->
                        ...
                        <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-6">
                                    <!--begin::Name-->
                                    <a href="#"
                                        class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">จิตใจ
                                        ใจดี
                                        <span class="badge badge-light fs-8 fw-semibold ms-2">Software
                                            Enginer</span></a>
                                    <!--end::Name-->
                                    <!--begin::Email-->
                                    <div class="fw-semibold text-muted">jaidee@eva.com</div>
                                    <!--end::Email-->
                                </div>
                                <!--end::Details-->
                            </div>
                        ...
                        <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-6">
                                    <!--begin::Name-->
                                    <a href="#"
                                        class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">สมหมาย
                ...
                <div class="d-flex justify-content-between">
                    <!--begin::Label-->
                    <div class="fw-semibold">
                        <label class="fs-6">ตั้งค่าระบบติดตามผู้ใช้งาน</label>
                        <div class="fs-7 text-muted">ระบบติดตามผู้ใช้งานจะบันทึกการทำงานของระบบทุกขั้นตอน</div>
                    </div>
                    <!--end::Label-->
                    <!--begin::Switch-->
                    <label class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" value="" checked="checked" />
                        <span class="form-check-label fw-semibold text-muted">ใช้งาน</span>
                    </label>
                    <!--end::Switch-->
                </div>
                <!--end::Notice-->
                        ...
                        <div data-kt-search-element="suggestions">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <a href="#"
                                    ...
                                    <!--begin::Info-->
                                    <div class="fw-semibold">
                                        <span class="fs-6 text-gray-800 me-2">จิตใจ ใจดี</span>
                                ...
                                <a href="#"
                                    ...
                                    <!--begin::Info-->
                                    <div class="fw-semibold">
                                        <span class="fs-6 text-gray-800 me-2">สมหมาย</span>
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">จิตใจ
                                                ใจดี</a>
                                            <div class="fw-semibold text-muted">jaidee@eva.com</div>
                                        </div>
                                        <!--end::Details-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <a href="#"
                                                class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">สมหมาย</a>
                                            <div class="fw-semibold text-muted">brian@exchange.com</div>
                                        </div>
                                        <!--end::Details-->
                                    </div>
                    ...
                    <div class="mh-300px scroll-y me-n7 pe-7">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Details-->
                                <div class="ms-5">
                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">สมหมาย</a>
                                    <div class="fw-semibold text-muted">brian@exchange.com</div>
                                </div>
                                <!--end::Details-->
                            </div>
...
<script src="../assets/js/custom/utilities/modals/modal-simple.js"></script>
