...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
    ...
    data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="false" data-kt-app-aside-push-toolbar="true"
    data-kt-app-aside-push-footer="true" data-kt-app-sidebar-minimize="on" class="app-default">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
                        <?php 
                            if(($_SESSION["R"][1]==1)||($_SESSION["CstCode"]=="CUS22-00001")){
                        ?>
                        <!--begin::Logo-->
                        <a href="../Dashboard" class="app-sidebar-logo">
                            <img alt="Logo" src="../assets/media/logos/logo.png" class="h-50px theme-light-show" />
                        </a>
                        <?php
                            } 
                        ?>
                        ...
                        <!-- begin::MainMenu-->
                        <div
                            class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0">
                            <!--begin:Menu item-->
                            <div class="menu-item here menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                                <!--begin:Menu link-->
                                <div class="app-navbar-item ms-lg-6">
                                    <!--begin::Menu- wrapper-->
                                    <!--
									<div
										class="btn btn-icon btn-custom btn-color-gray-600 bg-body btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
                        ...
                        <div class="app-navbar-item ms-lg-6">
                            ...
                            <div class="btn btn-icon btn-custom btn-color-gray-600 bg-body btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../Project">
                                            ...
                                            <span class="menu-title">โครงการ</span>
                                        </a>
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../SetupPoint">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">จุดติดตั้ง</span>
                                        </a>
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../VmsRirect">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">ป้ายVMS</span>
                                        </a>
                    ...
                    <div class="app-navbar flex-grow-1 justify-content-center" id="kt_app_header_navbar">
                         <h3 style="color:white" class="pt-2"><?php //echo $_SESSION["CustName"];?></h3>
                    </div>
                    <!--begin::Navbar-->
                    <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                            ...
                            <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px"
                                ...
                                <form data-kt-search-element="form"
                                    ...
                                    <input type="text"
                                        ...
                                        name="search" value="" placeholder="ค้นหา..." data-kt-search-element="input" />
                                    <!--end::Input-->
                                    <!--begin::Spinner-->
                                    <span
                                ...
                                <div data-kt-search-element="content"
                                    ...
                                    <div data-kt-search-element="wrapper">
                                        ...
                                        <div class="" data-kt-search-element="main">
                                            ...
                                            <div class="d-flex flex-stack fw-semibold mb-4">
                                                <!--begin::Label-->
                                                <span class="text-muted fs-6 me-2">การค้นหาล่าสุด:</span>
                                                <!--end::Label-->
                                                <!--begin::Toolbar-->
                                                <div class="d-flex" data-kt-search-element="toolbar">
                                                    ...
                                                    <div data-kt-search-element="advanced-options-form-show"
                                                        ...
                                                        data-bs-toggle="tooltip" title="แสดงการค้นหาเพิ่มเติม">
                                            ...
                                            <div class="scroll-y mh-200px mh-lg-325px">
                                                ...
                                                <div class="d-flex align-items-center mb-5">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="#"
                                                            class="fs-6 text-gray-800 text-hover-primary fw-semibold">IOT
                                                            Video 1XXX</a>
                                    ...
                                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                        <!--begin::Heading-->
                                        <h3 class="fw-semibold text-dark mb-7">การค้นหาเพิ่มเติม</h3>
                                        <!--end::Heading-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-sm form-control-solid"
                                                placeholder="ระบุคำที่ต้องการค้นหา" name="query" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            ...
                                            <div class="nav-group nav-group-fluid">
                                                ...
                                                <label>
                                                    <input type="radio" class="btn-check" name="type" value="has"
                                                        checked="checked" />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary">ทั้งหมด</span>
                                                </label>
                                                <!--end::Option-->
                                                <!--begin::Option-->
                                                <label>
                                                    ...
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">ผู้ใช้งาน</span>
                                                </label>
                                                <!--end::Option-->
                                                <!--begin::Option-->
                                                <label>
                                                    ...
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">อุปกรณ์</span>
                                                </label>
                                                <!--end::Option-->
                                                <!--begin::Option-->
                                                <label>
                                                    <input type="radio" class="btn-check" name="type"
                                                        value="projects" />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">สถานที่</span>
                                                </label>
                                                <!--end::Option-->
                                            </div>
                                            <!--end::Radio group-->
                                        ...
                                        <div class="mb-5">
                                            <input type="text" name="assignedto"
                                                ...
                                                placeholder="ระบุหมายเลขอุปกรณ์" value="" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" name="collaborators"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="บุคคลที่เกี่ยวข้อง" value="" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            ...
                                            <div class="nav-group nav-group-fluid">
                                                ...
                                                <label>
                                                    <input type="radio" class="btn-check" name="attachment" value="has"
                                                        checked="checked" />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary">มีไฟล์แนบ</span>
                                                </label>
                                                <!--end::Option-->
                                                <!--begin::Option-->
                                                <label>
                                                    <input type="radio" class="btn-check" name="attachment"
                                                        value="any" />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">ไม่ระบุ</span>
                                                </label>
                                                <!--end::Option-->
                                            </div>
                                            <!--end::Radio group-->
                                        ...
                                        <div class="mb-5">
                                            <select name="timezone" aria-label="Select a Timezone"
                                                ...
                                                <option value="next">ภายในเดือนปัจจุบัน</option>
                                                <option value="last">ภายใน 1 ปีล่าสุด</option>
                                                <option value="between">ระหว่าง</option>
                                                <option value="on">ภายใน</option>
                                            </select>
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="reset"
                                                ...
                                                data-kt-search-element="advanced-options-form-cancel">ยกเลิก</button>
                                            <a href="#" class="btn btn-sm fw-bold btn-primary"
                                                data-kt-search-element="advanced-options-form-search">ค้นหา</a>
                                        </div>
                                        <!--end::Actions-->
                                    </form>
                                    <!--end::Preferences-->
                                    ...
                                    <form data-kt-search-element="preferences" class="pt-1 d-none">
                                        <!--begin::Heading-->
                                        <h3 class="fw-semibold text-dark mb-7">การตั้งค่าการค้นหา</h3>
                                        <!--end::Heading-->
                                        <!--begin::Input group-->
                                        <div class="pb-4 border-bottom">
                                            <label
                                                ...
                                                <span
                                                    class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">แสดงหัวข้อ</span>
                                        ...
                                        <div class="py-4 border-bottom">
                                            <label
                                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                                <span
                                                    class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">แสดงคำอธิบาย</span>
                                                <input class="form-check-input" type="checkbox" value="1"
                                                    checked="checked" />
                                            </label>
                                        </div>
                                        ...
                                        <div class="py-4 border-bottom">
                                            <label
                                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                                <span
                                                    class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">แสดงไอคอน</span>
                                                <input class="form-check-input" type="checkbox" value="1" />
                                            </label>
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="py-4 border-bottom">
                                            <label
                                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                                <span
                                                    class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">แสดงจำนวน</span>
                                                <input class="form-check-input" type="checkbox" value="1"
                                                    checked="checked" />
                                            </label>
                                        </div>
                                        ...
                                        <div class="py-4 border-bottom">
                                            <label
                                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                                <span
                                                    class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">แสดงสีสถานะ</span>
                                                <input class="form-check-input" type="checkbox" value="1" />
                                            </label>
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="d-flex justify-content-end pt-7">
                                            <button type="reset"
                                                class="btn btn-sm btn-light fw-bold btn-active-light-primary me-2"
                                                data-kt-search-element="preferences-dismiss">ยกเลิก</button>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <!--begin::Username-->
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold d-flex align-items-center fs-5"><?php echo $_SESSION["UsrName"];?>
                                                <span
                                            ...
                                            <a href="#"
                                                class="fw-semibold text-muted text-hover-primary fs-7"><?php echo  $_SESSION["UsrCode"];?></a>
                                        </div>
                                        <!--end::Username-->
                                    </div>
                                </div>
                                ...
                                <div class="menu-item px-5">
                                    <a href="#" class="menu-link px-5">บัญชีของฉัน</a>
                                </div>
                                --
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                ...
                                <div class="menu-item px-5">
                                    <a href="#" class="menu-link px-5">
                                        <span class="menu-text">กล่องข้อความ</span>
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <a href="#" class="menu-link px-5">
                                        <span class="menu-title position-relative">โหมดการแสดงผล
                        ...
                        <div class="app-navbar-item ms-2 ms-lg-6 me-lg-5">
                            ...
                            <a href="../Logout"
                                ...
                                <i class="fa fa-power-off fs-2"></i>
                                <!--end::Svg Icon-->
                            </a>
                            <!--end::Link-->
                        </div>
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    ...
                    <div class="d-flex flex-column flex-column-fluid mb-3">
                        <!--begin::Content-->
