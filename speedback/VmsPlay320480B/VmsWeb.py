...
def DownLoadTemplateLabel(UrlTF,UrlMedia,UrlTfUserName,UrlTfPassWord,VmsCode):
    ...
    try:
         ...
         print("Error DownLoadTemplateLabel")   
         return False             
