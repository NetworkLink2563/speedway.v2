...
<?php
    ...
    $Label='<div id="divlabel">';
    for($i=0;$i<count($obj);$i++){
      $Label.='<p id="Label'.$obj[$i]->XILineNumber.'" style="color:white;font-size: 14px;position:absolute;top:'.$obj[$i]->XVLabelPosition_Y.';left:280px;">'.$obj[$i]->XVTime.'</p>';
    }
    $Label.='</div>';
?>
...
<body style="background-color: black;cursor: none;">
    <div id="MyCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" style="height: 288px;width: 384px;overflow: hidden;background-color: black;">
            <?php
                $indexmap='';
                for($i=0;$i<count($obj);$i++){
                    $active="";
                    ...
                    if($obj[$i]->XVMediaType==1){
                        $data='<div  style="height: 288px;width: 384px;overflow: hidden;background-color: black;">
                               <div style="height: 288px;width: 384px;overflow: hidden;background-color: black;">'.$obj[$i]->XVSms.'</div>
                               </div>';
                    }
                    ...
                    if($obj[$i]->XVMediaType==3){
                        ...
                        $data='<div  style="height: 288px;width: 384px;overflow: hidden;background-color: black;">
                               <video style="height: 288px;width: 384px;overflow: hidden;background-color: black;" controls autoplay><source src="IMG/'.$obj[$i]->XVFileName.'" type="video/mp4"></video>
                        </div>';
                    }
            ...
            ?>
            <div class="carousel-item <?php echo $active;?>" data-interval="<?php $obj[$i]->XIDelay*1000;?>">
...
function caltime(s){
    ...
    if(s > 60){
        ...
        strtime=h.toFixed(2)+" ชั่วโมง";
    }else{
        strtime=s.toFixed(2)+" นาที";
    }
