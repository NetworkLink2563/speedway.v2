            ...
            <div class="modal-body">
                ...
                <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="XVPrjCode" name="XVPrjCode" value="" disabled="disabled" class="form-control ">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" id="XVCstCode" name="XVCstCode" >     
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                           <input type="text" id="XVPrjNamechk" name="XVPrjNamechk" style="display: none;" required="required" class="form-control ">
                            <input type="text" id="XVPrjName" name="XVPrjName" required="required" class="form-control ">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <textarea type="text" id="XVPrjDescription" name="XVPrjDescription" required="required" class="form-control "></textarea>
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select  id="XVPrjType" name="XVPrjType" class="form-control ">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="XVPrjLineToken1" name="XVPrjLineToken1" required="required" class="form-control ">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="XVPrjLineToken2" name="XVPrjLineToken2" required="required" class="form-control ">
                        </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group" style=" text-align: center;">
                        <div class="col-md-12 col-sm-12 offset-md-6">
                            ...
                            <a  onclick="editprojx();" class="btn btn-success">แก้ไข</a>
                        </div>
                    </div>
                </form>
