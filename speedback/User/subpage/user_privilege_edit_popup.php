...
<div id="editprivl" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <input  type="text" hidden value="" id="editprival" >
                ...
                <form  class="form-horizontal form-label-left" >
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            ...
                            <select id="usrprie" name="usrprie" class="form-control" style="width:100%;">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <select id="pri_user_e" name="pri_user_e" multiple="multiple" class="form-control" style="width:100%;">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <select id="menuide" name="menuide" class="form-control">
                    ...
                    <div class="item form-group" style=" text-align: center;">
                        <div class="col-md-12 col-sm-12 offset-md-6">
                            ...
                            <a onclick="editprix();" class="btn btn-success" >แก้ไขสิทธิ์</a>
                        </div>
                    </div>
                </form>
