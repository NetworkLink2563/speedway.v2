                ...
                <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                    ...
                    <div class="x_content">
                        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#homex" role="tab" aria-controls="home" aria-selected="true">ข้อมูลผู้ใช้งาน</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contactx" role="tab" aria-controls="contact" aria-selected="false">สถานะการใช้งาน</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profilex" role="tab" aria-controls="profile" aria-selected="false">กะเวลาการทำงาน</a>
                            </li>
                           
                        </ul>
                        <div class="tab-content" id="myTabContent">
                       <br>
                            <div class="tab-pane fade active in" id="homex" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="XVUsrCodex" name="XVUsrCodex" disabled="disabled"  class="form-control has-feedback-left">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="password" id="XVUsrPwdx" name="XVUsrPwdx" value="NWL"  class="form-control ">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="XVUsrNamex" name="XVUsrNamex"  class="form-control has-feedback-left">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="XVUsrPhonex" name="XVUsrPhonex"  class="form-control has-feedback-right" maxlength="10">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select  id="XVDptCodex" name="XVDptCodex"  class="form-control" >
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" id="idcustx" name="idcustx" onchange="editgetproj();">
                  ...
                  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" id="XVUsrDefaultPrjx" name="XVUsrDefaultPrjx" >
                            </select>
                        </div>
                    </div>
                </div>

                        <div class="tab-pane fade" id="profilex" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" id="XVShfCodex" name="XVShfCodex">
                            ...
                            <div class="tab-pane fade" id="contactx" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">สถานะการใช้งาน <span class="required">*</span>
                        </label> <!-- สถานะจาก Admin Customer อนุญาต -->
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" id="XBUsrIsActivex" name="XBUsrIsActivex">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" id="XBUsrIsCstAdminx" name="XBUsrIsCstAdminx">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="nameregisx" disabled name="nameregisx" value="<?php echo date('d-m-Y H:i:s'); ?>" class="form-control">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="datetimechkx" disabled name="datetimechkx" value="<?php echo $_SESSION['XVUsrCode']; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="item form-group" style=" text-align: center;">
                        <div class="col-md-12 col-sm-12 offset-md-6">
                            ...
                            <a onclick="editliuser();" class="btn btn-success">แก้ไข</a>
                        </div>
                    </div>
                </form>
