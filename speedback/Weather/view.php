                ...
                <div class="row g-5 g-xl-10 mb-xl-10">
                    ...
                    <div class="card pt-3">
                        <div class="text-center">
                           <h3>เครื่องวัดสภาพอากาศ</h3>
                        </div>
                        <div> <?php
                            if( $_SESSION["CstCode"]=="CUS22-00001"){ 
                        ?>
                            <button style="position: absolute; top: 5%; z-index: 10;" type="button" id="BtnAdd" class="btn btn-dark ms-4 py-1 fs-8">
                                <i class="" <?php echo $Permis[1];?>></i>
                                เพิ่มเครื่องวัดสภาพอากาศ</button>
                                <?php
                            }
                        ?>
                        </div>
                ...
                <form id="FormSetupPoint" class="user" method="POST" action="Controller.php">
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 ">
                            <label class="m-0">รหัสเครื่องวัดสภาพอากาศ:</label>
                            <input type="text" class="form-control w-25" value="" WSSYY-XXXXX"
                                placeholder="" id="TxtWssCode" autocomplete="off" disabled>
                        </div>
                    </div>
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 m-0">
                            <label class="m-0">จุดติดตั้ง:</label>
                            <select <?php echo $Permis[1];?> id="SelSupCode" class=" form-control w-50" required>
                    ...
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 m-0">
                            ...
                            <select <?php echo $Permis[1];?> id="SelVmsCode" class=" form-control w-50" >
                    ...
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 ">
                            <label class="m-0">ชื่อเครื่องวัดสภาพอากาศ:</label>
                            <input type="text" class=" form-control w-75" placeholder=""
                                id="TxtWssName" autocomplete="off" <?php echo $Permis[1];?> required>
                        </div>
                    </div>
                    <div class="form-group row m-1">
                        <div class="col-sm-12 mb-3 mb-sm-0 m-0">
                            ...
                            <input type="text" class=" form-control w-25" placeholder=""
                                id="TxtSN" autocomplete="off" <?php echo $Permis[1];?> required>
                        </div>
                    </div>
