...
$ret='{"RETURN":"False"}';
$sql="SELECT XVVmsCode,XVMsgCode FROM TMstMItmVMSMessage where XVMsgCode='$msgCODE'";

$XVVmsName="";
$count=0;
$query = sqlsrv_query($conn, $sql);
while($result2 = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC)){
   $XVVmsCode=$result2["XVVmsCode"];  
   $count++;
}
