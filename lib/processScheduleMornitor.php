...
SELECT '" . $resultProcedSQL['ptCode'] . "','" . date('Y-m-d') . "','".date('Y-m-d H:i:s')."','" . $vmsID . "','003','1','','','".$time."','0','1','".$value."','','".$sun."','".$mon."','".$tue."','".$wed."','".$thu."','".$fri."','".$sat."','".$_SESSION['userName']."','','".date('Y-m-d H:i:s')."','".date('Y-m-d H:i:s')."'";
