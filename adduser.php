...
<script>
    ...
    function addUser() {
        var conf = confirm('คุณต้องการสร้างชื่อผู้ใช้งานใหม่ใช่หรือไม่');
        if(conf==true){
        ...
        var XVShfCode = document.getElementById("SelXVShfCode").value;
         if(XVShfCode==''){
            alert('กรุณาเลือกกะเวลาทำงานด้วยค่ะ');
            return;
         }
        $.ajax({
            type: "POST",
            ...
            success: function(result) {
                ...
                window.location.href = "setting.php";
                    ...
                    alert('มีชื่อผู้ใช้งานซ้ำค่ะ');
                }else{
                    alert('กรุณาติดต่อเจ้าที่ดูแลระบบ');
                }
...
<div class="container" style="position: relative; top: 75;">
    ...
    <div class="flex-container" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
        ...
        <div class="row col-12" style="margin-top: 2rem;">
            ...
            <div class="col-6"><input type="email" id="emailaddress" name="emailaddress" class="form-control input" style="width: 100%;" placeholder=" Username" autocomplete="off" required autofocus>
            </div>
        </div>

        <div hidden class="row col-12" style="padding-top:10px">
            <div class="col-6" style="margin-top: 5px; text-align: right;">
                <span>รหัสผ่าน</span>
            </div>
            <div class="col-6">
                <input placeholder="Password" value="nwl" class="form-control input" style="width: 100%;" name="passwordInput" id="passwordInput" type="password" onkeyup='check();' /><i style="display_: none; text-align: right; cursor: pointer; position: absolute; top: 12px; left: 203px;" class="far fa-eye fa-eye-slash" id="togglePassword"></i>
            </div>
        </div>
        ...
        <div hidden class="row col-12" style="padding-top:10px">
            ...
            <div class="col-6">
                <input placeholder="Confirm Password" class="form-control input" style="width: 100%;" value="nwl" name="confirm_password" id="confirm_password" type="password" onkeyup='check();' />
        ...
        <div class="row col-12" style="padding-top:10px; justify-content: center; align-items: center;">
            ...
            <div class="col-6">
                <select id="SelXVShfCode" class="input" style="width: 100%; background-color: #e6f5ff;">
                    ...
                    <option value="">เลือกเวลาเข้าทำงาน</option>
                    <?php
        ...
        <div class="row col-12" style="padding-top:10px; justify-content: center; align-items: center;">
            <div class="col-2" style="margin: 2rem; display: flex; justify-content: center; align-items: center;">
                <button style="width: 70%; box-shadow: 3px 3px 3px #aaaaaa !important;" type="button" class="btn btn-success" onclick="addUser();">สร้างผู้ใช้งาน</button>
            </div>
        </div>
    </div>
</div>
