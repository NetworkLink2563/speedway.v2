...
<div class="centered" style="margin-top: 60;margin-left: 10;width:90%">
            ...
            <div class="row">
                <div class="col-sm-4" >
                    ...
                    <div style="border-style: solid;border-color:#DCDCDC;margin:5px;padding:5px;border-width: 2px;">
                       ...
                       <div onclick="frame1_show()" style="cursor: pointer;text-align: center;margin-top:5px;border-style: solid;border-color:#DCDCDC;margin:5px;padding:5px;border-width: 2px;"><p style="maring:0px;padding:0px;">แบบข้อความเดี่ยว</p><img src="img/f1.png" alt="Girl in a jacket" width="100%" height="100"></div>
                       <div style="cursor: pointer;text-align: center;margin-top:5px;border-style: solid;border-color:#DCDCDC;margin:5px;padding:5px;border-width: 2px;"><p style="maring:0px;padding:0px;">แบบ 2 ข้อความ 3 ช่อง</p><img src="img/f2.png" alt="Girl in a jacket" width="100%" height="100"></div>
                       <div style="cursor: pointer;text-align: center;margin-top:5px;border-style: solid;border-color:#DCDCDC;margin:5px;padding:5px;border-width: 2px;"><p style="maring:0px;padding:0px;">แบบ 1 ข้อความ 2 ช่อง</p><img src="img/f3.png" alt="Girl in a jacket" width="100%" height="100"></div>
                    </div>
                </div>
