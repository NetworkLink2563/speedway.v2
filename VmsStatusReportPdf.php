...
<body>
    <pageheader name="MyHeader1" content-left="รายงงานสถานะป้าย" content-right="{PAGENO}/{nbpg}" header-style="font-weight: bold; color: #000000;" line="on" />

    <pagefooter name="MyFooter1" content-left="" content-center="" footer-style="font-size: 8pt;" line="on"/>';

$data='<table width="99%" border="1" cellpadding="3" cellspacing="0" style="font-size: 9pt;">
            ...
            while($resultSQL = sqlsrv_fetch_array($querySQL, SQLSRV_FETCH_ASSOC))
            {
                ...
                $data.='<td ><div align="center" style="margin-left: 2;margin-right: 2">'.$isActive.'</td>';
